    ...
    <div className={`min-h-screen ${bgPage} transition-colors duration-300 px-4 py-6`}>
      ...
      <div className="flex justify-center">
        <div className={`w-full max-w-sm rounded-2xl ${cardBg} border ${cardBorder} p-6 sm:p-8 shadow-xl transition-colors duration-300`}>
          ...
          <p className={`text-center mb-6 ${subColor}`}>AI Expense Tracker</p>
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            className={`w-full rounded-lg ${btnBg} ${btnText} py-3 font-semibold transition opacity-100 ${loading ? "opacity-60 cursor-not-allowed" : ""}`}
          >
