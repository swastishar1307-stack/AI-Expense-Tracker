  ...
  return (
    <div className={`min-h-screen ${bgPage} transition-colors duration-300 px-4 py-6`}>
      ...
      <div className="flex justify-center">
        <div className={`w-full max-w-md rounded-2xl ${cardBg} border ${cardBorder} p-6 sm:p-8 shadow-xl`}>

          <h1 className={`text-2xl font-bold text-center mb-6 ${titleColor}`}>Add Expense</h1>
